...
const socials = [
    {
        label: 'Instagram',
        href: 'https://www.instagram.com/entre_n0ss/',
        icon: (
    ...
    {
        label: 'Facebook',
        href: 'https://www.facebook.com/profile.php?id=61550028362620',
        icon: (
            <svg viewBox='0 0 24 24' fill='currentColor' className='w-4 h-4'>
    ...
    {
        label: 'TikTok',
        href: 'https://www.tiktok.com/@lamata.horto',
        icon: (
            <svg viewBox='0 0 24 24' fill='currentColor' className='w-4 h-4'>
                <path d='M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.88a8.17 8.17 0 004.78 1.54V7.01a4.85 4.85 0 01-1.01-.32z' />
            </svg>
        ),
    },
    {
        label: 'WhatsApp',
        href: 'https://chat.whatsapp.com/J3IRiS5DLrJFqhP9gTjLpQ?s=cl&p=i&ilr=4',
        icon: (
            <svg viewBox='0 0 24 24' fill='currentColor' className='w-4 h-4'>
        ...
        <footer className='bg-dark-green px-6 md:px-[10vw]'>
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-8 py-12 border-b border-eucalyptus/15'>
                ...
                <div className='flex flex-col gap-4 items-start md:items-end'>
                    ...
                    <div className='flex gap-4 text-eucalyptus/60'>
                        {socials.map(s => (
                            <a
                                key={s.label}
                                href={s.href}
