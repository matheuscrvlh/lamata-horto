            ...
            >
                ...
                <div className='flex flex-col sm:flex-row gap-4 mb-10'>
                    ...
                    <a
                        ...
                        target='_blank'
                        rel='noopener noreferrer'
                        className='border border-dark-green text-dark-green text-xs tracking-widest uppercase px-8 py-4 text-center hover:bg-dark-green hover:text-ivory transition-colors flex items-center justify-center gap-2'
                    >
